...
* 🟢 [pico_ecs](https://github.com/empyreanx/pico_headers) - Single-header and cross-platform ECS. [⭐ 544](https://github.com/empyreanx/pico_headers)
...
* 🟢 [DragonECS](https://github.com/DCFApixels/DragonECS) - ECS for Unity and .NET. [⭐ 330](https://github.com/DCFApixels/DragonECS)
...
* 🟢 [Fennecs](https://github.com/outfox/fennecs) - ... the tiny, tiny, high-energy Entity-Component System! [⭐ 442](https://github.com/outfox/fennecs)
* 🟢 [Frent](https://github.com/itsBuggingMe/Frent) - Data oriented ECF with an ECS api for C#, Godot, and Unity. [⭐ 172](https://github.com/itsBuggingMe/Frent)
* 🟢 [Friflo Engine ECS](https://github.com/friflo/Friflo.Engine.ECS) - ECS for .NET with focus on performance, cache locality and DX. [⭐ 657](https://github.com/friflo/Friflo.Engine.ECS)
...
* 🟢 [Morpeh](https://github.com/scellecs/morpeh) - ECS Framework for Unity Game Engine and .NET Platform. [⭐ 645](https://github.com/scellecs/morpeh)
...
* 🟢 [esper](https://github.com/benmoran56/esper) - A lightweight Entity System for Python. [⭐ 690](https://github.com/benmoran56/esper)

#### Rust

* 🟢 [bevy_ecs](https://github.com/bevyengine/bevy/tree/main/crates/bevy_ecs) - Simple to use, ergonomic, fast, massively parallel, opinionated, and featureful written in Rust. [⭐ 46.5k](https://github.com/bevyengine/bevy)
...
* 🟢 [shipyard](https://github.com/leudz/shipyard) - Entity Component System written in Rust. [⭐ 859](https://github.com/leudz/shipyard)
...
* 🟢 [Ark](https://github.com/mlange-42/ark) - An archetype-based Entity Component System for Go. [⭐ 280](https://github.com/mlange-42/ark)
...
* 🟡 [Concord](https://github.com/Keyslam-Group/Concord) - A feature-complete ECS library. [⭐ 316](https://github.com/Keyslam-Group/Concord)
...
* 🟢 [Ark.jl](https://github.com/ark-ecs/Ark.jl) - An archetype-based Entity Component System (ECS) for Julia. It is a port of the Go ECS Ark. [⭐ 78](https://github.com/ark-ecs/Ark.jl)
...
* 🟢 [Nazara Engine](https://github.com/NazaraEngine/NazaraEngine) - Cross-platform framework aimed at real-time applications requiring audio, 2D and 3D real-time rendering, network and more. [⭐ 828](https://github.com/NazaraEngine/NazaraEngine)
...
* 🟢 [supernova](https://github.com/supernovaengine/supernova) - Game engine for 2D and 3D projects with ECS and data-oriented design. [⭐ 405](https://github.com/supernovaengine/supernova)
...
* 🟢 [Bevy](https://github.com/bevyengine/bevy) - A refreshingly simple data-driven game engine built in Rust. [⭐ 46.5k](https://github.com/bevyengine/bevy)
...
* 🟢 [edyn](https://github.com/xissburg/edyn) - A real-time physics engine organized as an ECS. [⭐ 775](https://github.com/xissburg/edyn)
...
* 🟢 [ECS C# Benchmark](https://github.com/Doraku/Ecs.CSharp.Benchmark) - Benchmarks of the main ECS Frameworks for: C#. [⭐ 179](https://github.com/Doraku/Ecs.CSharp.Benchmark)
