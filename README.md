...
* 🟢 [entt](https://github.com/skypjack/entt) - Fast and reliable entity-component system. [⭐ 12.7k](https://github.com/skypjack/entt)
...
* 🔴 [Kengine](https://github.com/phisko/kengine) - Game engine with an Entity-Component-System (ECS) architecture. [⭐ 618](https://github.com/phisko/kengine)
...
* 🟢 [pico_ecs](https://github.com/empyreanx/pico_headers) - Single-header and cross-platform ECS. [⭐ 538](https://github.com/empyreanx/pico_headers)
...
* 🔴 [DefaultEcs](https://github.com/Doraku/DefaultEcs) - ECS for syntax and usage simplicity with maximum performance. [⭐ 759](https://github.com/Doraku/DefaultEcs)
* 🟢 [DragonECS](https://github.com/DCFApixels/DragonECS) - ECS for Unity and .NET. [⭐ 329](https://github.com/DCFApixels/DragonECS)
...
* 🟢 [Fennecs](https://github.com/outfox/fennecs) - ... the tiny, tiny, high-energy Entity-Component System! [⭐ 439](https://github.com/outfox/fennecs)
* 🟢 [Frent](https://github.com/itsBuggingMe/Frent) - Data oriented ECF with an ECS api for C#, Godot, and Unity. [⭐ 171](https://github.com/itsBuggingMe/Frent)
* 🟢 [Friflo Engine ECS](https://github.com/friflo/Friflo.Engine.ECS) - ECS for .NET with focus on performance, cache locality and DX. [⭐ 649](https://github.com/friflo/Friflo.Engine.ECS)
...
* 🟢 [Massive ECS](https://github.com/nilpunch/massive-ecs) - Bitset-based ECS with rollbacks. C# library and Unity package. [⭐ 210](https://github.com/nilpunch/massive-ecs)
...
* 🟢 [Morpeh](https://github.com/scellecs/morpeh) - ECS Framework for Unity Game Engine and .NET Platform. [⭐ 644](https://github.com/scellecs/morpeh)
* 🟢 [Static ECS](https://github.com/Felid-Force-Studios/StaticEcs) - C# Hierarchical Inverted Bitmap ECS framework. [⭐ 182](https://github.com/Felid-Force-Studios/StaticEcs)
...
* 🟢 [esper](https://github.com/benmoran56/esper) - A lightweight Entity System for Python. [⭐ 688](https://github.com/benmoran56/esper)

#### Rust

* 🟢 [bevy_ecs](https://github.com/bevyengine/bevy/tree/main/crates/bevy_ecs) - Simple to use, ergonomic, fast, massively parallel, opinionated, and featureful written in Rust. [⭐ 46.4k](https://github.com/bevyengine/bevy)
...
* 🟢 [shipyard](https://github.com/leudz/shipyard) - Entity Component System written in Rust. [⭐ 858](https://github.com/leudz/shipyard)
...
* 🟢 [Ark](https://github.com/mlange-42/ark) - An archetype-based Entity Component System for Go. [⭐ 279](https://github.com/mlange-42/ark)
* 🔴 [ecs](https://github.com/EngoEngine/ecs) - A Go-implementation of the Entity-Component-System paradigm. [⭐ 334](https://github.com/EngoEngine/ecs)

#### Lua

* 🟡 [Concord](https://github.com/Keyslam-Group/Concord) - A feature-complete ECS library. [⭐ 317](https://github.com/Keyslam-Group/Concord)
* 🔴 [ECS Lua](https://github.com/nidorx/ecs-lua) - A fast and easy to use ECS engine for game development. [⭐ 227](https://github.com/nidorx/ecs-lua)
* 🟢 [evolved.lua](https://github.com/BlackMATov/evolved.lua) - Evolved ECS (Entity-Component-System) for Lua. [⭐ 212](https://github.com/BlackMATov/evolved.lua)
...
* 🔴 [Artemis-odb](https://github.com/junkdog/artemis-odb) - A continuation of the popular Artemis ECS framework. [⭐ 833](https://github.com/junkdog/artemis-odb)

#### Julia

* 🟢 [Ark.jl](https://github.com/ark-ecs/Ark.jl) - An archetype-based Entity Component System (ECS) for Julia. It is a port of the Go ECS Ark. [⭐ 75](https://github.com/ark-ecs/Ark.jl)

#### Kotlin

* 🟢 [Fleks](https://github.com/Quillraven/Fleks) - Fast, lightweight, multi-platform entity component system in Kotlin. [⭐ 258](https://github.com/Quillraven/Fleks)

#### JavaScript / TypeScript

* 🟡 [becsy](https://github.com/LastOliveGames/becsy) - A multithreaded Entity Component System (ECS) for TypeScript and JavaScript, inspired by ECSY and bitecs. [⭐ 294](https://github.com/LastOliveGames/becsy)
...
* 🟢 [Zig ECS](https://github.com/prime31/zig-ecs) - A Zig port of the fantasic Entt. [⭐ 415](https://github.com/prime31/zig-ecs)

#### Haskell

* 🟢 [apecs](https://github.com/jonascarpay/apecs) - A fast, extensible, type driven Haskell ECS framework for games. [⭐ 415](https://github.com/jonascarpay/apecs)
...
* 🔴 [kengine](https://github.com/phisko/kengine) - Game engine focused on ease-of-use, runtime extensibility and compile-time type safety. [⭐ 618](https://github.com/phisko/kengine)
* 🟢 [Lina Engine](https://github.com/inanevin/LinaEngine) - Modular, tiny and fast C++ game engine, aimed to develop 3D desktop games. [⭐ 897](https://github.com/inanevin/LinaEngine)
...
* 🟢 [Nazara Engine](https://github.com/NazaraEngine/NazaraEngine) - Cross-platform framework aimed at real-time applications requiring audio, 2D and 3D real-time rendering, network and more. [⭐ 825](https://github.com/NazaraEngine/NazaraEngine)
...
* 🟢 [supernova](https://github.com/supernovaengine/supernova) - Game engine for 2D and 3D projects with ECS and data-oriented design. [⭐ 401](https://github.com/supernovaengine/supernova)
...
* 🟢 [Bevy](https://github.com/bevyengine/bevy) - A refreshingly simple data-driven game engine built in Rust. [⭐ 46.4k](https://github.com/bevyengine/bevy)
...
* 🟢 [edyn](https://github.com/xissburg/edyn) - A real-time physics engine organized as an ECS. [⭐ 774](https://github.com/xissburg/edyn)
...
* 🟡 [ecs_benchmark](https://github.com/abeimler/ecs_benchmark) - Benchmarks of common ECS (Entity-Component-System)-Frameworks in C/C++. [⭐ 298](https://github.com/abeimler/ecs_benchmark)
