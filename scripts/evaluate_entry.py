...
CATEGORY_TO_YAML = {
    ...
    "ECS Libraries: C#": "ecs-libraries",
    "ECS Libraries: Common Lisp": "ecs-libraries",
    "ECS Libraries: Dart": "ecs-libraries",
    "ECS Libraries: Elixir": "ecs-libraries",
    "ECS Libraries: Python": "ecs-libraries",
    "ECS Libraries: Rust": "ecs-libraries",
    "ECS Libraries: Go": "ecs-libraries",
    "ECS Libraries: Lua": "ecs-libraries",
    "ECS Libraries: Java": "ecs-libraries",
    "ECS Libraries: Julia": "ecs-libraries",
    "ECS Libraries: Kotlin": "ecs-libraries",
    "ECS Libraries: JavaScript / TypeScript": "ecs-libraries",
    "ECS Libraries: Zig": "ecs-libraries",
    "ECS Libraries: Haskell": "ecs-libraries",
    "ECS Libraries: Other Language": "ecs-libraries",
...
def format_report(result: dict) -> str:
    ...
    if rec == "accept":
        ...
        lines.append(
            ...
            "**Exceptions**: If this project has historical significance to the ECS community "
            "(like EntityX or Artemis), please comment below explaining its importance and "
...
def main() -> int:
    ...
    parser.add_argument("repo", help="GitHub owner/repo (e.g., skypjack/entt)")
    parser.add_argument(
